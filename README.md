...
Esse projeto foi baseado no jogo Trivia.
<br/>
Trivia é um jogo de perguntas e resposta famoso, no Brasil algo que se assemelha a ele é o Show do milhão do apresentador Sílvio santos.

---

# Habilidades

Nesse projeto, foi testado:
...
Para viver um cenário mais proximo do mercado de trabalho, foi feita uma copia do quadro para ultilizar em grupo e minimizar os conflitos no GitHub.
...
1. Clone o repositório
  * `git clone git@github.com:KesleyMuniz/Trivia.git`
...
### Como funciona a API de Trivia

A [API do Trivia](https://opentdb.com/api_config.php) é bem simples. Temos 2 endpoints.
...
```
O token expira em 6 horas e te retornará um `response_code: 3` caso esteja expirado. Caso o token seja inválido, essa será a resposta da API:
...
- [Contribuições]
  - [Carla](https://github.com/carlatakagi)
  - [Carol](https://github.com/Carolyla)
